...
import classes from "./ProfExperience.module.css"

export default function ProfessionalExperience() {
  return (
    <section className={classes.section} id="ProfessionalExperience">
      <div className={classes.sectionTitleContainer}>
      <h2 className={classes.sectionTitle}>Professional Experience</h2>
      </div>
